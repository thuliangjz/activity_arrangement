...
try:
	user1 = User.objects.get(username = 'yit15')
except ObjectDoesNotExist:
	user1 =  User.objects.create_user(username = 'yit15', password = '19970718')
place1 = Place.objects.get_or_create(name = '紫操')[0]
...
a = Activity(	name = '活动1_3',
	...
	state = 1,num_participants = 80,privilege = 0,place = place1,user = user1)
a.save()
...
a = Activity(	name = '活动3_5',
	...
	state = 1,num_participants = 80,privilege = 2,place = place1,user = user1)
a.save()
a = Activity(	name = '活动3_6',
	time_start = datetime(2017,7,2,5),
	time_end = datetime(2017,7,2,6),
	state = 1,num_participants = 80,privilege = 2,place = place1,user = user1)
a.save()
a = Activity(	name = '活动3_7',
	time_start = datetime(2017,7,5,9),
	time_end = datetime(2017,7,5,11),
	state = 1,num_participants = 80,privilege = 2,place = place1,user = user1)
a.save()
a = Activity(	name = '活动3_8',
	time_start = datetime(2017,7,5,12),
	time_end = datetime(2017,7,5,15),
	state = 1,num_participants = 80,privilege = 2,place = place1,user = user1)
a.save()
