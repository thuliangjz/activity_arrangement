...
APPLYING = 1
APPLIED = 2
CHOICE_PRIVILEGE = ((0, '第一志愿'),(1, '第二志愿'),(2, '第三志愿'))
DIC_NUM_STR = {0: '未申请', 1: '正在申请', 2:'已申请'}
class Activity(models.Model):
	name = models.CharField(max_length = 256)
<<<<<<< HEAD
	time_start = models.DateTimeField()	#may set default value
	time_end = models.DateTimeField()    #may set default value
	state = models.IntegerField()		#use one of the const defined above, may set default value
=======
	time_start = models.DateTimeField()
	time_end = models.DateTimeField()
	state = models.IntegerField()		#use one of the const defined above
>>>>>>> e620b0d55d885d661a6a020626f6e6065a904403
